 ...
 *
 * 1) Compilation - for developers in google using the library this file
 *     should be added to the externs of their build target.
 *
 * 2) Auto Complete - for developers using the library wishing to enable auto
 *     complete for objects and functions provided by the Google Visualization
 *     API.
 *
...
google.charts.setOnLoadCallback = function(onLoadCallback) {};
...
google.visualization.arrayToDataTable = function(array, opt_noHeaders) {};

google.visualization.drawChart = function(specification, opt_container) {};

google.visualization.data = {};
google.visualization.data.avg = function(a) {};
google.visualization.data.count = function(a) {};
google.visualization.data.group = function(a, b, c) {};
google.visualization.data.join = function(a, b, c, d, e, f) {};
google.visualization.data.max = function(a) {};
google.visualization.data.min = function(a) {};
google.visualization.data.month = function(a) {};
google.visualization.data.sum = function(a) {};